<template>
  <div class="content FJMain">
    <div style="flex:1;overflow: hidden;display: flex;flex-direction: column;">
      <div class="peopleData">
        <div class="propleSearch">
          ...
          <div @keyup.13="watch()" style="display:inline">
            <el-input
              placeholder="请刷卡"
              v-model="cardNum"
              class="arcRadius"
      ...
      >
        ...
        <el-table-column prop="sex" label="姓名" width="80"></el-table-column>
        <el-table-column prop="sex" label="性别" width="50"></el-table-column>
        <el-table-column prop="age" label="年龄" sortable width="100"></el-table-column>
        <el-table-column prop="cardNum" label="体检卡号" sortable width="100"></el-table-column>
        <el-table-column prop="packageName" label="电话" width="200"></el-table-column>
        <el-table-column prop="isPaid" label="身份证" width="200"></el-table-column>
        <el-table-column prop="paidMoney" label="单位"></el-table-column>
        <el-table-column label="身份确认" sortable width="200">
    ...
    <dialogcard ref="dialogcard"></dialogcard>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    //查看详情，父传子
    watch(row, index) {
      this.$refs.dialogcard.dialogcardVisible = true;
      this.$refs.dialogcard.orderCode = row.orderCode;
      this.$refs.dialogcard.depts = this.options;
      this.$refs.dialogcard.customerName = row.customerName;
      this.$refs.dialogcard.sex = row.sex;
      this.$refs.dialogcard.age = row.age;
      this.$refs.dialogcard.idcardNum = row.idcardNum;
      this.$refs.dialogcard.marriageState = row.marriageState;
      this.$refs.dialogcard.headImg = "data:image/png;base64," + row.headImg;
    }
  }
};
</script>
